sap.ui.define([
    ...
    return {
        onOpenDialog: function (oEvent) {
            if (!this.pDialog) {
                this.pDialog = this.loadFragment({
                    name: "fullstackdevchallenge.custom.fragment.QuestionsCount",
                })
            }
        ...
        onSubmitDialog: async function (oEvent) {
            ...
            const oOperation = oModel.bindContext(`/Tests(ID=${tests.ID},IsActiveEntity=true)/DevChallengeService.assignQuestionsToTest(...)`)
